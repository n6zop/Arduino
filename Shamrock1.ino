...
#define SER    0  // data in
#define SRCLK  1  // shift register clock
#define SRCLR  4  // clear shift register
#define RCLK   2  // storage register (sometimes called the latch pin)
#define OE     3  // enable output

#define TOTAL_SHIFT_PINS  32 //Total number of LEDS
...
void pingPongSine() {
  ...
  const int NUM_LOOPS = 10;  // repeat the pattern this many times
